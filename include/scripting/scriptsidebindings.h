...
struct _functionStruct
{
    ...
    GfxLitMaterialImpl *(*f200)(bool arg0);
    GfxTexture *(*f201)(const String & arg0, const String & arg1);
    GfxTexture *(*f202)(const String & arg0);
    PhysicsShapeImpl *(*f203)();
    PhysicsShapeImpl *(*f204)(size_t count);
    PhysicsDebugDrawer *(*f205)();
    PhysicsDebugDrawer *(*f206)(size_t count);
    Application *(*f207)(const char * arg0);
    GfxModel *(*f208)(const String & arg0);
    GfxModel *(*f209)(const String & arg0, const String & arg1);
    Scene *(*f210)(const String & arg0);
    Scene *(*f211)(const String & arg0, const String & arg1);
    File *(*f212)(const char * arg0, const char * arg1);
    Matrix3x3 *(*f213)();
    Matrix3x3 *(*f214)(size_t count);
    Matrix3x3 *(*f215)(const Matrix4x4 & arg0);
    Matrix3x3 *(*f216)(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2);
    GfxDebugDrawer *(*f217)(GfxApi * arg0);
};
...
void GfxTexture::setShadowmap(bool arg0)  { _functions->f109(this, arg0);}
 PhysicsShapeImpl::PhysicsShapeImpl()  { _functions->f110(this);}
...
void Entity::addRigidBody(PhysicsWorld * arg0, const RigidBody::ConstructionInfo & arg1)  { _functions->f119(this, arg0, arg1);}
void File::read(size_t arg0, void * arg1)  { _functions->f120(this, arg0, arg1);}
void File::write(size_t arg0, const void * arg1)  { _functions->f121(this, arg0, arg1);}
void File::seek(long arg0, File::Origin arg1)  { _functions->f122(this, arg0, arg1);}
long File::tell()  {return _functions->f123(this);}
void File::flush()  { _functions->f124(this);}
bool File::isAtEndOfFile()  {return _functions->f125(this);}
size_t File::getSize()  {return _functions->f126(this);}
uint8_t File::readUInt8()  {return _functions->f127(this);}
int8_t File::readInt8()  {return _functions->f128(this);}
uint16_t File::readUInt16LE()  {return _functions->f129(this);}
int16_t File::readInt16LE()  {return _functions->f130(this);}
uint32_t File::readUInt32LE()  {return _functions->f131(this);}
int32_t File::readInt32LE()  {return _functions->f132(this);}
uint64_t File::readUInt64LE()  {return _functions->f133(this);}
int64_t File::readInt64LE()  {return _functions->f134(this);}
uint16_t File::readUInt16BE()  {return _functions->f135(this);}
int16_t File::readInt16BE()  {return _functions->f136(this);}
uint32_t File::readUInt32BE()  {return _functions->f137(this);}
int32_t File::readInt32BE()  {return _functions->f138(this);}
uint64_t File::readUInt64BE()  {return _functions->f139(this);}
int64_t File::readInt64BE()  {return _functions->f140(this);}
float File::readFloat32()  {return _functions->f141(this);}
char File::readChar()  {return _functions->f142(this);}
void File::writeUInt8(uint8_t arg0)  { _functions->f143(this, arg0);}
void File::writeInt8(int8_t arg0)  { _functions->f144(this, arg0);}
void File::writeUInt16LE(uint16_t arg0)  { _functions->f145(this, arg0);}
void File::writeInt16LE(int16_t arg0)  { _functions->f146(this, arg0);}
void File::writeUInt32LE(uint32_t arg0)  { _functions->f147(this, arg0);}
void File::writeInt32LE(int32_t arg0)  { _functions->f148(this, arg0);}
void File::writeUInt64LE(uint64_t arg0)  { _functions->f149(this, arg0);}
void File::writeInt64LE(int64_t arg0)  { _functions->f150(this, arg0);}
void File::writeUInt16BE(uint16_t arg0)  { _functions->f151(this, arg0);}
void File::writeInt16BE(int16_t arg0)  { _functions->f152(this, arg0);}
void File::writeUInt32BE(uint32_t arg0)  { _functions->f153(this, arg0);}
void File::writeInt32BE(int32_t arg0)  { _functions->f154(this, arg0);}
void File::writeUInt64BE(uint64_t arg0)  { _functions->f155(this, arg0);}
void File::writeInt64BE(int64_t arg0)  { _functions->f156(this, arg0);}
void File::writeFloat32(float arg0)  { _functions->f157(this, arg0);}
void File::vprintf(const char * arg0, va_list arg1)  { _functions->f158(this, arg0, arg1);}
void File::writeChar(char arg0)  { _functions->f159(this, arg0);}
 File::File(const char * arg0, const char * arg1)  { _functions->f160(this, arg0, arg1);}
 File::~File()  { _functions->f161(this);}
GfxCompiledShader * GfxShaderCombination::getCompiledVertexShader() const {return _functions->f162(this);}
GfxCompiledShader * GfxShaderCombination::getCompiledTessControlShader() const {return _functions->f163(this);}
GfxCompiledShader * GfxShaderCombination::getCompiledTessEvalShader() const {return _functions->f164(this);}
GfxCompiledShader * GfxShaderCombination::getCompiledGeometryShader() const {return _functions->f165(this);}
GfxCompiledShader * GfxShaderCombination::getCompiledFragmentShader() const {return _functions->f166(this);}
Matrix3x3 Matrix3x3::operator*(const Matrix3x3 & arg0) const {return _functions->f167(this, arg0);}
Float3 Matrix3x3::operator*(const Float3 & arg0) const {return _functions->f168(this, arg0);}
Matrix3x3 Matrix3x3::operator/(float arg0) const {return _functions->f169(this, arg0);}
Matrix3x3 Matrix3x3::transpose() const {return _functions->f170(this);}
Matrix3x3 Matrix3x3::inverse() const {return _functions->f171(this);}
Matrix3x3 Matrix3x3::translate(const Float2 & arg0)  {return _functions->f172(arg0);}
Matrix3x3 Matrix3x3::scale(const Float3 & arg0)  {return _functions->f173(arg0);}
Matrix3x3 Matrix3x3::rotate(float arg0)  {return _functions->f174(arg0);}
Matrix3x3 Matrix3x3::rotatex(float arg0)  {return _functions->f175(arg0);}
Matrix3x3 Matrix3x3::rotatey(float arg0)  {return _functions->f176(arg0);}
Matrix3x3 Matrix3x3::rotatez(float arg0)  {return _functions->f177(arg0);}
 Matrix3x3::Matrix3x3()  { _functions->f178(this);}
 Matrix3x3::Matrix3x3(const Matrix4x4 & arg0)  { _functions->f179(this, arg0);}
 Matrix3x3::Matrix3x3(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2)  { _functions->f180(this, arg0, arg1, arg2);}
void GfxDebugDrawer::render(const Camera & arg0)  { _functions->f181(this, arg0);}
 GfxDebugDrawer::GfxDebugDrawer(GfxApi * arg0)  { _functions->f182(this, arg0);}
 GfxDebugDrawer::~GfxDebugDrawer()  { _functions->f183(this);}
Script *_newScript(const String & arg0) {return _functions->f184(arg0);}
Script *_newScript(const String & arg0, const String & arg1) {return _functions->f185(arg0, arg1);}
GfxMaterial *_newGfxMaterial(const String & arg0) {return _functions->f186(arg0);}
GfxMaterial *_newGfxMaterial(const String & arg0, const String & arg1) {return _functions->f187(arg0, arg1);}
LookupException *_newLookupException(const char * arg0, size_t arg1, const char * arg2) {return _functions->f188(arg0, arg1, arg2);}
Quaternion *_newQuaternion() {return _functions->f189();}
Quaternion *_newArrayQuaternion(size_t count) {return _functions->f190(count);}
Quaternion *_newQuaternion(const Direction3D & arg0, float arg1) {return _functions->f191(arg0, arg1);}
Quaternion *_newQuaternion(float arg0, float arg1, float arg2, float arg3) {return _functions->f192(arg0, arg1, arg2, arg3);}
Quaternion *_newQuaternion(const Float3 & arg0) {return _functions->f193(arg0);}
PhysicsShape *_newPhysicsShape(const String & arg0) {return _functions->f194(arg0);}
PhysicsShape *_newPhysicsShape(const String & arg0, const String & arg1) {return _functions->f195(arg0, arg1);}
ShaderCompileException *_newShaderCompileException(const char * arg0, size_t arg1, const char * arg2, const String & arg3) {return _functions->f196(arg0, arg1, arg2, arg3);}
Exception *_newException(const char * arg0, size_t arg1, const char * arg2) {return _functions->f197(arg0, arg1, arg2);}
...
GfxLitMaterialImpl *_newGfxLitMaterialImpl(bool arg0) {return _functions->f200(arg0);}
GfxTexture *_newGfxTexture(const String & arg0, const String & arg1) {return _functions->f201(arg0, arg1);}
GfxTexture *_newGfxTexture(const String & arg0) {return _functions->f202(arg0);}
PhysicsShapeImpl *_newPhysicsShapeImpl() {return _functions->f203();}
PhysicsShapeImpl *_newArrayPhysicsShapeImpl(size_t count) {return _functions->f204(count);}
PhysicsDebugDrawer *_newPhysicsDebugDrawer() {return _functions->f205();}
PhysicsDebugDrawer *_newArrayPhysicsDebugDrawer(size_t count) {return _functions->f206(count);}
Application *_newApplication(const char * arg0) {return _functions->f207(arg0);}
GfxModel *_newGfxModel(const String & arg0) {return _functions->f208(arg0);}
GfxModel *_newGfxModel(const String & arg0, const String & arg1) {return _functions->f209(arg0, arg1);}
Scene *_newScene(const String & arg0) {return _functions->f210(arg0);}
Scene *_newScene(const String & arg0, const String & arg1) {return _functions->f211(arg0, arg1);}
File *_newFile(const char * arg0, const char * arg1) {return _functions->f212(arg0, arg1);}
Matrix3x3 *_newMatrix3x3() {return _functions->f213();}
Matrix3x3 *_newArrayMatrix3x3(size_t count) {return _functions->f214(count);}
Matrix3x3 *_newMatrix3x3(const Matrix4x4 & arg0) {return _functions->f215(arg0);}
Matrix3x3 *_newMatrix3x3(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {return _functions->f216(arg0, arg1, arg2);}
GfxDebugDrawer *_newGfxDebugDrawer(GfxApi * arg0) {return _functions->f217(arg0);}
