...
GfxTexture *f212(const String & arg0) {return NEW(GfxTexture, arg0);}
GfxTexture *f213() {return NEW(GfxTexture);}
GfxTexture *f214(size_t count) {return NEW_ARRAY(GfxTexture, count);}
PhysicsShapeImpl *f215() {return NEW(PhysicsShapeImpl);}
PhysicsShapeImpl *f216(size_t count) {return NEW_ARRAY(PhysicsShapeImpl, count);}
PhysicsDebugDrawer *f217() {return NEW(PhysicsDebugDrawer);}
PhysicsDebugDrawer *f218(size_t count) {return NEW_ARRAY(PhysicsDebugDrawer, count);}
Application *f219(const char * arg0) {return NEW(Application, arg0);}
GfxModel *f220() {return NEW(GfxModel);}
GfxModel *f221(size_t count) {return NEW_ARRAY(GfxModel, count);}
GfxModel *f222(const String & arg0) {return NEW(GfxModel, arg0);}
Scene *f223() {return NEW(Scene);}
Scene *f224(size_t count) {return NEW_ARRAY(Scene, count);}
Scene *f225(const String & arg0) {return NEW(Scene, arg0);}
File *f226(const char * arg0, const char * arg1) {return NEW(File, arg0, arg1);}
GfxShaderCombination *f227(ResPtr<GfxShader> arg0, ResPtr<GfxShader> arg1) {return NEW(GfxShaderCombination, arg0, arg1);}
Matrix3x3 *f228() {return NEW(Matrix3x3);}
Matrix3x3 *f229(size_t count) {return NEW_ARRAY(Matrix3x3, count);}
Matrix3x3 *f230(const Matrix4x4 & arg0) {return NEW(Matrix3x3, arg0);}
Matrix3x3 *f231(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {return NEW(Matrix3x3, arg0, arg1, arg2);}
Font *f232(const char * arg0) {return NEW(Font, arg0);}
GfxDebugDrawer *f233(GfxApi * arg0) {return NEW(GfxDebugDrawer, arg0);}
