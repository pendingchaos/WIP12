...
void f95( Application *obj) { obj->mainloop();}
void f96( Application *obj, const char * arg0) {new (obj) Application(arg0);}
void f97( Application *obj) { obj->~Application();}
void f98( Scene *obj) { obj->handleInput();}
void f99( Scene *obj) { obj->update();}
void f100( Scene *obj, float arg0) { obj->fixedUpdate(arg0);}
...
void f103( Entity *obj, PhysicsWorld * arg0, const RigidBody::ConstructionInfo & arg1, ResPtr<PhysicsShape> arg2) { obj->addRigidBody(arg0, arg1, arg2);}
void f104( File *obj, size_t arg0, void * arg1) { obj->read(arg0, arg1);}
void f105( File *obj, size_t arg0, const void * arg1) { obj->write(arg0, arg1);}
void f106( File *obj, long arg0, File::Origin arg1) { obj->seek(arg0, arg1);}
long f107( File *obj) {return obj->tell();}
void f108( File *obj) { obj->flush();}
bool f109( File *obj) {return obj->isAtEndOfFile();}
size_t f110( File *obj) {return obj->getSize();}
uint8_t f111( File *obj) {return obj->readUInt8();}
int8_t f112( File *obj) {return obj->readInt8();}
uint16_t f113( File *obj) {return obj->readUInt16LE();}
int16_t f114( File *obj) {return obj->readInt16LE();}
uint32_t f115( File *obj) {return obj->readUInt32LE();}
int32_t f116( File *obj) {return obj->readInt32LE();}
uint64_t f117( File *obj) {return obj->readUInt64LE();}
int64_t f118( File *obj) {return obj->readInt64LE();}
uint16_t f119( File *obj) {return obj->readUInt16BE();}
int16_t f120( File *obj) {return obj->readInt16BE();}
uint32_t f121( File *obj) {return obj->readUInt32BE();}
int32_t f122( File *obj) {return obj->readInt32BE();}
uint64_t f123( File *obj) {return obj->readUInt64BE();}
int64_t f124( File *obj) {return obj->readInt64BE();}
float f125( File *obj) {return obj->readFloat32();}
char f126( File *obj) {return obj->readChar();}
void f127( File *obj, uint8_t arg0) { obj->writeUInt8(arg0);}
void f128( File *obj, int8_t arg0) { obj->writeInt8(arg0);}
void f129( File *obj, uint16_t arg0) { obj->writeUInt16LE(arg0);}
void f130( File *obj, int16_t arg0) { obj->writeInt16LE(arg0);}
void f131( File *obj, uint32_t arg0) { obj->writeUInt32LE(arg0);}
void f132( File *obj, int32_t arg0) { obj->writeInt32LE(arg0);}
void f133( File *obj, uint64_t arg0) { obj->writeUInt64LE(arg0);}
void f134( File *obj, int64_t arg0) { obj->writeInt64LE(arg0);}
void f135( File *obj, uint16_t arg0) { obj->writeUInt16BE(arg0);}
void f136( File *obj, int16_t arg0) { obj->writeInt16BE(arg0);}
void f137( File *obj, uint32_t arg0) { obj->writeUInt32BE(arg0);}
void f138( File *obj, int32_t arg0) { obj->writeInt32BE(arg0);}
void f139( File *obj, uint64_t arg0) { obj->writeUInt64BE(arg0);}
void f140( File *obj, int64_t arg0) { obj->writeInt64BE(arg0);}
void f141( File *obj, float arg0) { obj->writeFloat32(arg0);}
void f142( File *obj, const char * arg0, va_list arg1) { obj->vprintf(arg0, arg1);}
void f143( File *obj, char arg0) { obj->writeChar(arg0);}
void f144( File *obj, const char * arg0, const char * arg1) {new (obj) File(arg0, arg1);}
void f145( File *obj) { obj->~File();}
Matrix3x3 f146(const Matrix3x3 *obj, const Matrix3x3 & arg0) {return obj->operator*(arg0);}
Float3 f147(const Matrix3x3 *obj, const Float3 & arg0) {return obj->operator*(arg0);}
Matrix3x3 f148(const Matrix3x3 *obj, float arg0) {return obj->operator/(arg0);}
Matrix3x3 f149(const Matrix3x3 *obj) {return obj->transpose();}
Matrix3x3 f150(const Matrix3x3 *obj) {return obj->inverse();}
Matrix3x3 f151(const Float2 & arg0) {return Matrix3x3::translate(arg0);}
Matrix3x3 f152(const Float3 & arg0) {return Matrix3x3::scale(arg0);}
Matrix3x3 f153(float arg0) {return Matrix3x3::rotate(arg0);}
Matrix3x3 f154(float arg0) {return Matrix3x3::rotatex(arg0);}
Matrix3x3 f155(float arg0) {return Matrix3x3::rotatey(arg0);}
Matrix3x3 f156(float arg0) {return Matrix3x3::rotatez(arg0);}
void f157( Matrix3x3 *obj) {new (obj) Matrix3x3();}
void f158( Matrix3x3 *obj, const Matrix4x4 & arg0) {new (obj) Matrix3x3(arg0);}
void f159( Matrix3x3 *obj, const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {new (obj) Matrix3x3(arg0, arg1, arg2);}
void f160( Font *obj, size_t arg0, const Float2 & arg1, const char * arg2, GfxFramebuffer * arg3, const Float3 & arg4) { obj->render(arg0, arg1, arg2, arg3, arg4);}
void f161( Font *obj, const char * arg0) {new (obj) Font(arg0);}
void f162( Font *obj) { obj->~Font();}
void f163( GfxDebugDrawer *obj, const Camera & arg0) { obj->render(arg0);}
void f164( GfxDebugDrawer *obj, GfxApi * arg0) {new (obj) GfxDebugDrawer(arg0);}
void f165( GfxDebugDrawer *obj) { obj->~GfxDebugDrawer();}
AudioSource *f166(ResPtr<Audio> arg0) {return NEW(AudioSource, arg0);}
Script *f167() {return NEW(Script);}
Script *f168(size_t count) {return NEW_ARRAY(Script, count);}
Script *f169(const String & arg0) {return NEW(Script, arg0);}
AudioDevice *f170(size_t arg0, size_t arg1, size_t arg2) {return NEW(AudioDevice, arg0, arg1, arg2);}
GfxMaterial *f171() {return NEW(GfxMaterial);}
GfxMaterial *f172(size_t count) {return NEW_ARRAY(GfxMaterial, count);}
GfxMaterial *f173(const String & arg0) {return NEW(GfxMaterial, arg0);}
SerializeException *f174(const char * arg0, size_t arg1, const char * arg2) {return NEW(SerializeException, arg0, arg1, arg2);}
LookupException *f175(const char * arg0, size_t arg1, const char * arg2) {return NEW(LookupException, arg0, arg1, arg2);}
Quaternion *f176() {return NEW(Quaternion);}
Quaternion *f177(size_t count) {return NEW_ARRAY(Quaternion, count);}
Quaternion *f178(const Direction3D & arg0, float arg1) {return NEW(Quaternion, arg0, arg1);}
Quaternion *f179(float arg0, float arg1, float arg2, float arg3) {return NEW(Quaternion, arg0, arg1, arg2, arg3);}
Quaternion *f180(const Float3 & arg0) {return NEW(Quaternion, arg0);}
Light *f181() {return NEW(Light);}
Light *f182(size_t count) {return NEW_ARRAY(Light, count);}
PhysicsShape *f183() {return NEW(PhysicsShape);}
PhysicsShape *f184(size_t count) {return NEW_ARRAY(PhysicsShape, count);}
PhysicsShape *f185(const String & arg0) {return NEW(PhysicsShape, arg0);}
Serializable *f186() {return NEW(Serializable);}
Serializable *f187(size_t count) {return NEW_ARRAY(Serializable, count);}
Serializable *f188(uint8_t arg0) {return NEW(Serializable, arg0);}
Serializable *f189(int8_t arg0) {return NEW(Serializable, arg0);}
Serializable *f190(uint16_t arg0) {return NEW(Serializable, arg0);}
Serializable *f191(int16_t arg0) {return NEW(Serializable, arg0);}
Serializable *f192(uint32_t arg0) {return NEW(Serializable, arg0);}
Serializable *f193(int32_t arg0) {return NEW(Serializable, arg0);}
Serializable *f194(uint64_t arg0) {return NEW(Serializable, arg0);}
Serializable *f195(int64_t arg0) {return NEW(Serializable, arg0);}
Serializable *f196(const String & arg0) {return NEW(Serializable, arg0);}
Serializable *f197(bool arg0) {return NEW(Serializable, arg0);}
Serializable *f198(float arg0) {return NEW(Serializable, arg0);}
Serializable *f199(const Float2 & arg0) {return NEW(Serializable, arg0);}
Serializable *f200(const Float3 & arg0) {return NEW(Serializable, arg0);}
Serializable *f201(const Float4 & arg0) {return NEW(Serializable, arg0);}
Serializable *f202(const Int2 & arg0) {return NEW(Serializable, arg0);}
Serializable *f203(const Int3 & arg0) {return NEW(Serializable, arg0);}
Serializable *f204(const Int4 & arg0) {return NEW(Serializable, arg0);}
Serializable *f205(const UInt2 & arg0) {return NEW(Serializable, arg0);}
Serializable *f206(const UInt3 & arg0) {return NEW(Serializable, arg0);}
Serializable *f207(const UInt4 & arg0) {return NEW(Serializable, arg0);}
ShaderCompileException *f208(const char * arg0, size_t arg1, const char * arg2, const String & arg3) {return NEW(ShaderCompileException, arg0, arg1, arg2, arg3);}
Exception *f209(const char * arg0, size_t arg1, const char * arg2) {return NEW(Exception, arg0, arg1, arg2);}
PhysicsDebugDrawer *f210() {return NEW(PhysicsDebugDrawer);}
PhysicsDebugDrawer *f211(size_t count) {return NEW_ARRAY(PhysicsDebugDrawer, count);}
FileException *f212(const char * arg0, size_t arg1, const char * arg2, String arg3, String arg4) {return NEW(FileException, arg0, arg1, arg2, arg3, arg4);}
AABB *f213() {return NEW(AABB);}
AABB *f214(size_t count) {return NEW_ARRAY(AABB, count);}
AABB *f215(const Position3D & arg0, const Position3D & arg1) {return NEW(AABB, arg0, arg1);}
ResourceIOException *f216(const char * arg0, size_t arg1, const char * arg2, const String & arg3, const String & arg4, const String & arg5) {return NEW(ResourceIOException, arg0, arg1, arg2, arg3, arg4, arg5);}
AudioWorld *f217() {return NEW(AudioWorld);}
AudioWorld *f218(size_t count) {return NEW_ARRAY(AudioWorld, count);}
Audio *f219() {return NEW(Audio);}
Audio *f220(size_t count) {return NEW_ARRAY(Audio, count);}
Audio *f221(const String & arg0) {return NEW(Audio, arg0);}
GfxTexture *f222(const String & arg0) {return NEW(GfxTexture, arg0);}
GfxTexture *f223() {return NEW(GfxTexture);}
GfxTexture *f224(size_t count) {return NEW_ARRAY(GfxTexture, count);}
UserData *f225(const ScriptFunction<void *> & arg0, const ScriptFunction<void, void *> & arg1) {return NEW(UserData, arg0, arg1);}
Application *f226(const char * arg0) {return NEW(Application, arg0);}
GfxModel *f227() {return NEW(GfxModel);}
GfxModel *f228(size_t count) {return NEW_ARRAY(GfxModel, count);}
GfxModel *f229(const String & arg0) {return NEW(GfxModel, arg0);}
Scene *f230() {return NEW(Scene);}
Scene *f231(size_t count) {return NEW_ARRAY(Scene, count);}
Scene *f232(const String & arg0) {return NEW(Scene, arg0);}
File *f233(const char * arg0, const char * arg1) {return NEW(File, arg0, arg1);}
GfxShaderCombination *f234(ResPtr<GfxShader> arg0, ResPtr<GfxShader> arg1) {return NEW(GfxShaderCombination, arg0, arg1);}
Matrix3x3 *f235() {return NEW(Matrix3x3);}
Matrix3x3 *f236(size_t count) {return NEW_ARRAY(Matrix3x3, count);}
Matrix3x3 *f237(const Matrix4x4 & arg0) {return NEW(Matrix3x3, arg0);}
Matrix3x3 *f238(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {return NEW(Matrix3x3, arg0, arg1, arg2);}
Font *f239(const char * arg0) {return NEW(Font, arg0);}
GfxDebugDrawer *f240(GfxApi * arg0) {return NEW(GfxDebugDrawer, arg0);}
