...
struct _functionStruct
{
    ...
    GfxCompiledShader * (*f171)(const GfxShaderCombination *obj);
    GfxCompiledShader * (*f172)(const GfxShaderCombination *obj);
    Matrix3x3 (*f173)(const Matrix3x3 *obj, const Matrix3x3 & arg0);
    Float3 (*f174)(const Matrix3x3 *obj, const Float3 & arg0);
    Matrix3x3 (*f175)(const Matrix3x3 *obj, float arg0);
    Matrix3x3 (*f176)(const Matrix3x3 *obj);
    Matrix3x3 (*f177)(const Matrix3x3 *obj);
    Matrix3x3 (*f178)(const Float2 & arg0);
    Matrix3x3 (*f179)(const Float3 & arg0);
    Matrix3x3 (*f180)(float arg0);
    Matrix3x3 (*f181)(float arg0);
    Matrix3x3 (*f182)(float arg0);
    Matrix3x3 (*f183)(float arg0);
    void (*f184)( Matrix3x3 *obj);
    void (*f185)( Matrix3x3 *obj, const Matrix4x4 & arg0);
    void (*f186)( Matrix3x3 *obj, const Float3 & arg0, const Float3 & arg1, const Float3 & arg2);
    void (*f187)( Font *obj, size_t arg0, const Float2 & arg1, const char * arg2, GfxFramebuffer * arg3, const Float3 & arg4);
    void (*f188)( Font *obj, const char * arg0);
    void (*f189)( Font *obj);
...
GfxCompiledShader * f168(const GfxShaderCombination *obj) {return obj->getCompiledVertexShader();}
GfxCompiledShader * f169(const GfxShaderCombination *obj) {return obj->getCompiledTessControlShader();}
GfxCompiledShader * f170(const GfxShaderCombination *obj) {return obj->getCompiledTessEvalShader();}
GfxCompiledShader * f171(const GfxShaderCombination *obj) {return obj->getCompiledGeometryShader();}
GfxCompiledShader * f172(const GfxShaderCombination *obj) {return obj->getCompiledFragmentShader();}
Matrix3x3 f173(const Matrix3x3 *obj, const Matrix3x3 & arg0) {return obj->operator*(arg0);}
Float3 f174(const Matrix3x3 *obj, const Float3 & arg0) {return obj->operator*(arg0);}
Matrix3x3 f175(const Matrix3x3 *obj, float arg0) {return obj->operator/(arg0);}
Matrix3x3 f176(const Matrix3x3 *obj) {return obj->transpose();}
Matrix3x3 f177(const Matrix3x3 *obj) {return obj->inverse();}
Matrix3x3 f178(const Float2 & arg0) {return Matrix3x3::translate(arg0);}
Matrix3x3 f179(const Float3 & arg0) {return Matrix3x3::scale(arg0);}
Matrix3x3 f180(float arg0) {return Matrix3x3::rotate(arg0);}
Matrix3x3 f181(float arg0) {return Matrix3x3::rotatex(arg0);}
Matrix3x3 f182(float arg0) {return Matrix3x3::rotatey(arg0);}
Matrix3x3 f183(float arg0) {return Matrix3x3::rotatez(arg0);}
void f184( Matrix3x3 *obj) {new (obj) Matrix3x3();}
void f185( Matrix3x3 *obj, const Matrix4x4 & arg0) {new (obj) Matrix3x3(arg0);}
void f186( Matrix3x3 *obj, const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {new (obj) Matrix3x3(arg0, arg1, arg2);}
void f187( Font *obj, size_t arg0, const Float2 & arg1, const char * arg2, GfxFramebuffer * arg3, const Float3 & arg4) { obj->render(arg0, arg1, arg2, arg3, arg4);}
void f188( Font *obj, const char * arg0) {new (obj) Font(arg0);}
void f189( Font *obj) { obj->~Font();}
void f190( GfxDebugDrawer *obj, const Camera & arg0) { obj->render(arg0);}
void f191( GfxDebugDrawer *obj, GfxApi * arg0) {new (obj) GfxDebugDrawer(arg0);}
void f192( GfxDebugDrawer *obj) { obj->~GfxDebugDrawer();}
Script *f193(const String & arg0) {return NEW(Script, arg0);}
Script *f194(const String & arg0, const String & arg1) {return NEW(Script, arg0, arg1);}
GfxMaterial *f195(const String & arg0) {return NEW(GfxMaterial, arg0);}
GfxMaterial *f196(const String & arg0, const String & arg1) {return NEW(GfxMaterial, arg0, arg1);}
LookupException *f197(const char * arg0, size_t arg1, const char * arg2) {return NEW(LookupException, arg0, arg1, arg2);}
Quaternion *f198() {return NEW(Quaternion);}
Quaternion *f199(size_t count) {return NEW_ARRAY(Quaternion, count);}
Quaternion *f200(const Direction3D & arg0, float arg1) {return NEW(Quaternion, arg0, arg1);}
Quaternion *f201(float arg0, float arg1, float arg2, float arg3) {return NEW(Quaternion, arg0, arg1, arg2, arg3);}
Quaternion *f202(const Float3 & arg0) {return NEW(Quaternion, arg0);}
Light *f203() {return NEW(Light);}
Light *f204(size_t count) {return NEW_ARRAY(Light, count);}
PhysicsShape *f205(const String & arg0) {return NEW(PhysicsShape, arg0);}
PhysicsShape *f206(const String & arg0, const String & arg1) {return NEW(PhysicsShape, arg0, arg1);}
ShaderCompileException *f207(const char * arg0, size_t arg1, const char * arg2, const String & arg3) {return NEW(ShaderCompileException, arg0, arg1, arg2, arg3);}
Exception *f208(const char * arg0, size_t arg1, const char * arg2) {return NEW(Exception, arg0, arg1, arg2);}
FileException *f209(const char * arg0, size_t arg1, const char * arg2, String arg3, String arg4) {return NEW(FileException, arg0, arg1, arg2, arg3, arg4);}
ResourceIOException *f210(const char * arg0, size_t arg1, const char * arg2, const String & arg3, const String & arg4, const String & arg5) {return NEW(ResourceIOException, arg0, arg1, arg2, arg3, arg4, arg5);}
GfxLitMaterialImpl *f211(bool arg0) {return NEW(GfxLitMaterialImpl, arg0);}
GfxTexture *f212(const String & arg0, const String & arg1) {return NEW(GfxTexture, arg0, arg1);}
GfxTexture *f213(const String & arg0) {return NEW(GfxTexture, arg0);}
PhysicsShapeImpl *f214() {return NEW(PhysicsShapeImpl);}
PhysicsShapeImpl *f215(size_t count) {return NEW_ARRAY(PhysicsShapeImpl, count);}
PhysicsDebugDrawer *f216() {return NEW(PhysicsDebugDrawer);}
PhysicsDebugDrawer *f217(size_t count) {return NEW_ARRAY(PhysicsDebugDrawer, count);}
Application *f218(const char * arg0) {return NEW(Application, arg0);}
GfxModel *f219(const String & arg0) {return NEW(GfxModel, arg0);}
GfxModel *f220(const String & arg0, const String & arg1) {return NEW(GfxModel, arg0, arg1);}
Scene *f221(const String & arg0) {return NEW(Scene, arg0);}
Scene *f222(const String & arg0, const String & arg1) {return NEW(Scene, arg0, arg1);}
File *f223(const char * arg0, const char * arg1) {return NEW(File, arg0, arg1);}
Matrix3x3 *f224() {return NEW(Matrix3x3);}
Matrix3x3 *f225(size_t count) {return NEW_ARRAY(Matrix3x3, count);}
Matrix3x3 *f226(const Matrix4x4 & arg0) {return NEW(Matrix3x3, arg0);}
Matrix3x3 *f227(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {return NEW(Matrix3x3, arg0, arg1, arg2);}
Font *f228(const char * arg0) {return NEW(Font, arg0);}
GfxDebugDrawer *f229(GfxApi * arg0) {return NEW(GfxDebugDrawer, arg0);}
