...
Vector3D f57(const RigidBody *obj) {return obj->getGravity();}
void f58( RigidBody *obj, const Vector3D & arg0) { obj->setGravity(arg0);}
void f59( RigidBody *obj, float arg0) { obj->setLinearDamping(arg0);}
float f60(const RigidBody *obj) {return obj->getLinearDamping();}
void f61( RigidBody *obj, float arg0) { obj->setAngularDamping(arg0);}
float f62(const RigidBody *obj) {return obj->getAngularDamping();}
void f63(const RigidBody *obj, float arg0) { obj->setMass(arg0);}
float f64(const RigidBody *obj) {return obj->getMass();}
float f65(const RigidBody *obj) {return obj->getLinearSleepingThreshold();}
void f66( RigidBody *obj, float arg0) { obj->setLinearSleepingThreshold(arg0);}
float f67(const RigidBody *obj) {return obj->getAngularSleepingThreshold();}
void f68( RigidBody *obj, float arg0) { obj->setAngularSleepingThreshold(arg0);}
void f69( RigidBody *obj, const Vector3D & arg0) { obj->applyTorque(arg0);}
void f70( RigidBody *obj, const Vector3D & arg0, const Position3D & arg1) { obj->applyForce(arg0, arg1);}
void f71( RigidBody *obj, const Vector3D & arg0) { obj->applyCentralImpulse(arg0);}
void f72( RigidBody *obj, const Vector3D & arg0) { obj->applyTorqueImpulse(arg0);}
void f73( RigidBody *obj, const Vector3D & arg0, const Position3D & arg1) { obj->applyImpulse(arg0, arg1);}
void f74( RigidBody *obj) { obj->clearForces();}
Vector3D f75(const RigidBody *obj) {return obj->getLinearVelocity();}
void f76(const RigidBody *obj, const Vector3D & arg0) { obj->setLinearVelocity(arg0);}
Vector3D f77(const RigidBody *obj) {return obj->getAngularVelocity();}
void f78(const RigidBody *obj, const Vector3D & arg0) { obj->setAngularVelocity(arg0);}
Vector3D f79(const RigidBody *obj, const Position3D & arg0) {return obj->getVelocityOfPoint(arg0);}
float f80(const RigidBody *obj) {return obj->getRestitution();}
void f81( RigidBody *obj, float arg0) { obj->setRestitution(arg0);}
float f82(const RigidBody *obj) {return obj->getFriction();}
void f83( RigidBody *obj, float arg0) { obj->setFriction(arg0);}
float f84(const RigidBody *obj) {return obj->getRollingFriction();}
void f85( RigidBody *obj, float arg0) { obj->setRollingFriction(arg0);}
Float3 f86(const RigidBody *obj) {return obj->getLinearFactor();}
void f87(const RigidBody *obj, const Float3 & arg0) { obj->setLinearFactor(arg0);}
Float3 f88(const RigidBody *obj) {return obj->getAngularFactor();}
void f89(const RigidBody *obj, const Float3 & arg0) { obj->setAngularFactor(arg0);}
void f90(const RigidBody *obj, const Transform & arg0) { obj->setTransform(arg0);}
void f91( RigidBody *obj) { obj->setEmpty();}
void f92( RigidBody *obj, float arg0) { obj->setSphere(arg0);}
void f93( RigidBody *obj, const Vector3D & arg0) { obj->setBox(arg0);}
void f94( RigidBody *obj, PhysicsCylinderShape::Axis arg0, float arg1, float arg2) { obj->setCylinder(arg0, arg1, arg2);}
void f95( RigidBody *obj, PhysicsCapsuleShape::Axis arg0, float arg1, float arg2) { obj->setCapsule(arg0, arg1, arg2);}
void f96( RigidBody *obj, PhysicsConeShape::Axis arg0, float arg1, float arg2) { obj->setCone(arg0, arg1, arg2);}
void f97( RigidBody *obj, size_t arg0, const Position3D * arg1) { obj->setConvexHull(arg0, arg1);}
void f98( RigidBody *obj, size_t arg0, const Position3D * arg1) { obj->setStaticTriangleMesh(arg0, arg1);}
void f99( RigidBody *obj, uint32_t arg0, uint32_t arg1, const float * arg2) { obj->setHeightfield(arg0, arg1, arg2);}
void f100( RigidBody *obj, const Vector3D & arg0, float arg1) { obj->setPlane(arg0, arg1);}
void f101( RigidBody *obj, size_t arg0, const PhysicsCompoundShape::Child * arg1) { obj->setCompound(arg0, arg1);}
void f102( RigidBody *obj, ResPtr<PhysicsShape> arg0) { obj->setShape(arg0);}
void f103( Resource *obj) { obj->load();}
bool f104(const Resource *obj) {return obj->shouldReload();}
void f105( GfxTexture *obj, GfxTexture::TextureType arg0, bool arg1, unsigned int arg2, unsigned int arg3, unsigned int arg4, uint8_t arg5, GfxTexture::Purpose arg6, GfxTexture::Format arg7) { obj->startCreation(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);}
void f106( GfxTexture *obj, unsigned int arg0, unsigned int arg1, GfxTexture::Face arg2, const void * arg3) { obj->allocMipmapFace(arg0, arg1, arg2, arg3);}
void f107( GfxTexture *obj, unsigned int arg0, unsigned int arg1, const void * arg2) { obj->allocMipmap(arg0, arg1, arg2);}
void f108( GfxTexture *obj, unsigned int arg0, unsigned int arg1, GfxTexture::Face arg2, void * arg3) { obj->getMipmapFace(arg0, arg1, arg2, arg3);}
void f109( GfxTexture *obj, unsigned int arg0, unsigned int arg1, void * arg2) { obj->getMipmap(arg0, arg1, arg2);}
void f110( GfxTexture *obj) { obj->generateMipmaps();}
void f111( GfxTexture *obj, float arg0) { obj->setMaximumAnisotropy(arg0);}
void f112( GfxTexture *obj, GfxTexture::Filter arg0) { obj->setMinFilter(arg0);}
void f113( GfxTexture *obj, GfxTexture::Filter arg0) { obj->setMagFilter(arg0);}
void f114( GfxTexture *obj, GfxTexture::MipmapMode arg0) { obj->setMipmapMode(arg0);}
void f115( GfxTexture *obj, GfxTexture::WrapMode arg0) { obj->setWrapMode(arg0);}
void f116( GfxTexture *obj, bool arg0) { obj->setShadowmap(arg0);}
void f117( PhysicsShapeImpl *obj) {new (obj) PhysicsShapeImpl();}
void f118( Application *obj) { obj->mainloop();}
void f119( Application *obj, const char * arg0) {new (obj) Application(arg0);}
void f120( Application *obj) { obj->~Application();}
void f121( Scene *obj) { obj->handleInput();}
void f122( Scene *obj) { obj->update();}
void f123( Scene *obj, float arg0) { obj->fixedUpdate(arg0);}
Entity * f124( Scene *obj, const String & arg0) {return obj->createEntity(arg0);}
void f125( Scene *obj, size_t arg0) { obj->removeEntity(arg0);}
void f126( Entity *obj, PhysicsWorld * arg0, const RigidBody::ConstructionInfo & arg1) { obj->addRigidBody(arg0, arg1);}
...
void f184( Font *obj, const char * arg0) {new (obj) Font(arg0);}
void f185( Font *obj) { obj->~Font();}
void f186( GfxDebugDrawer *obj, const Camera & arg0) { obj->render(arg0);}
void f187( GfxDebugDrawer *obj, GfxApi * arg0) {new (obj) GfxDebugDrawer(arg0);}
void f188( GfxDebugDrawer *obj) { obj->~GfxDebugDrawer();}
Script *f189() {return NEW(Script);}
Script *f190(size_t count) {return NEW_ARRAY(Script, count);}
Script *f191(const String & arg0) {return NEW(Script, arg0);}
GfxMaterial *f192() {return NEW(GfxMaterial);}
GfxMaterial *f193(size_t count) {return NEW_ARRAY(GfxMaterial, count);}
GfxMaterial *f194(const String & arg0) {return NEW(GfxMaterial, arg0);}
LookupException *f195(const char * arg0, size_t arg1, const char * arg2) {return NEW(LookupException, arg0, arg1, arg2);}
Quaternion *f196() {return NEW(Quaternion);}
Quaternion *f197(size_t count) {return NEW_ARRAY(Quaternion, count);}
Quaternion *f198(const Direction3D & arg0, float arg1) {return NEW(Quaternion, arg0, arg1);}
Quaternion *f199(float arg0, float arg1, float arg2, float arg3) {return NEW(Quaternion, arg0, arg1, arg2, arg3);}
Quaternion *f200(const Float3 & arg0) {return NEW(Quaternion, arg0);}
Light *f201() {return NEW(Light);}
Light *f202(size_t count) {return NEW_ARRAY(Light, count);}
PhysicsShape *f203() {return NEW(PhysicsShape);}
PhysicsShape *f204(size_t count) {return NEW_ARRAY(PhysicsShape, count);}
