...
void f6( GfxRenderer *obj, const Camera & arg0, const Matrix4x4 & arg1, ResPtr<GfxMesh> arg2, GfxShaderCombination * arg3) { obj->beginRenderMesh(arg0, arg1, arg2, arg3);}
void f7( GfxRenderer *obj, ResPtr<GfxMesh> arg0) { obj->endRenderMesh(arg0);}
void f8( GfxRenderer *obj, const ResPtr<Scene> arg0) { obj->renderScene(arg0);}
void f9( GfxRenderer *obj) {new (obj) GfxRenderer();}
...
void f109( PhysicsShapeImpl *obj) {new (obj) PhysicsShapeImpl();}
...
Entity * f116( Scene *obj, const String & arg0) {return obj->createEntity(arg0);}
void f117( Scene *obj, size_t arg0) { obj->removeEntity(arg0);}
void f118( Entity *obj, PhysicsWorld * arg0, const RigidBody::ConstructionInfo & arg1) { obj->addRigidBody(arg0, arg1);}
void f119( File *obj, size_t arg0, void * arg1) { obj->read(arg0, arg1);}
void f120( File *obj, size_t arg0, const void * arg1) { obj->write(arg0, arg1);}
void f121( File *obj, long arg0, File::Origin arg1) { obj->seek(arg0, arg1);}
long f122( File *obj) {return obj->tell();}
void f123( File *obj) { obj->flush();}
bool f124( File *obj) {return obj->isAtEndOfFile();}
size_t f125( File *obj) {return obj->getSize();}
uint8_t f126( File *obj) {return obj->readUInt8();}
int8_t f127( File *obj) {return obj->readInt8();}
uint16_t f128( File *obj) {return obj->readUInt16LE();}
int16_t f129( File *obj) {return obj->readInt16LE();}
uint32_t f130( File *obj) {return obj->readUInt32LE();}
int32_t f131( File *obj) {return obj->readInt32LE();}
uint64_t f132( File *obj) {return obj->readUInt64LE();}
int64_t f133( File *obj) {return obj->readInt64LE();}
uint16_t f134( File *obj) {return obj->readUInt16BE();}
int16_t f135( File *obj) {return obj->readInt16BE();}
uint32_t f136( File *obj) {return obj->readUInt32BE();}
int32_t f137( File *obj) {return obj->readInt32BE();}
uint64_t f138( File *obj) {return obj->readUInt64BE();}
int64_t f139( File *obj) {return obj->readInt64BE();}
float f140( File *obj) {return obj->readFloat32();}
char f141( File *obj) {return obj->readChar();}
void f142( File *obj, uint8_t arg0) { obj->writeUInt8(arg0);}
void f143( File *obj, int8_t arg0) { obj->writeInt8(arg0);}
void f144( File *obj, uint16_t arg0) { obj->writeUInt16LE(arg0);}
void f145( File *obj, int16_t arg0) { obj->writeInt16LE(arg0);}
void f146( File *obj, uint32_t arg0) { obj->writeUInt32LE(arg0);}
void f147( File *obj, int32_t arg0) { obj->writeInt32LE(arg0);}
void f148( File *obj, uint64_t arg0) { obj->writeUInt64LE(arg0);}
void f149( File *obj, int64_t arg0) { obj->writeInt64LE(arg0);}
void f150( File *obj, uint16_t arg0) { obj->writeUInt16BE(arg0);}
void f151( File *obj, int16_t arg0) { obj->writeInt16BE(arg0);}
void f152( File *obj, uint32_t arg0) { obj->writeUInt32BE(arg0);}
void f153( File *obj, int32_t arg0) { obj->writeInt32BE(arg0);}
void f154( File *obj, uint64_t arg0) { obj->writeUInt64BE(arg0);}
void f155( File *obj, int64_t arg0) { obj->writeInt64BE(arg0);}
void f156( File *obj, float arg0) { obj->writeFloat32(arg0);}
void f157( File *obj, const char * arg0, va_list arg1) { obj->vprintf(arg0, arg1);}
void f158( File *obj, char arg0) { obj->writeChar(arg0);}
void f159( File *obj, const char * arg0, const char * arg1) {new (obj) File(arg0, arg1);}
void f160( File *obj) { obj->~File();}
GfxCompiledShader * f161(const GfxShaderCombination *obj) {return obj->getCompiledVertexShader();}
GfxCompiledShader * f162(const GfxShaderCombination *obj) {return obj->getCompiledTessControlShader();}
GfxCompiledShader * f163(const GfxShaderCombination *obj) {return obj->getCompiledTessEvalShader();}
GfxCompiledShader * f164(const GfxShaderCombination *obj) {return obj->getCompiledGeometryShader();}
GfxCompiledShader * f165(const GfxShaderCombination *obj) {return obj->getCompiledFragmentShader();}
Matrix3x3 f166(const Matrix3x3 *obj, const Matrix3x3 & arg0) {return obj->operator*(arg0);}
Float3 f167(const Matrix3x3 *obj, const Float3 & arg0) {return obj->operator*(arg0);}
Matrix3x3 f168(const Matrix3x3 *obj, float arg0) {return obj->operator/(arg0);}
Matrix3x3 f169(const Matrix3x3 *obj) {return obj->transpose();}
Matrix3x3 f170(const Matrix3x3 *obj) {return obj->inverse();}
Matrix3x3 f171(const Float2 & arg0) {return Matrix3x3::translate(arg0);}
Matrix3x3 f172(const Float3 & arg0) {return Matrix3x3::scale(arg0);}
Matrix3x3 f173(float arg0) {return Matrix3x3::rotate(arg0);}
Matrix3x3 f174(float arg0) {return Matrix3x3::rotatex(arg0);}
Matrix3x3 f175(float arg0) {return Matrix3x3::rotatey(arg0);}
Matrix3x3 f176(float arg0) {return Matrix3x3::rotatez(arg0);}
void f177( Matrix3x3 *obj) {new (obj) Matrix3x3();}
void f178( Matrix3x3 *obj, const Matrix4x4 & arg0) {new (obj) Matrix3x3(arg0);}
void f179( Matrix3x3 *obj, const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {new (obj) Matrix3x3(arg0, arg1, arg2);}
void f180( GfxDebugDrawer *obj, const Camera & arg0) { obj->render(arg0);}
void f181( GfxDebugDrawer *obj, GfxApi * arg0) {new (obj) GfxDebugDrawer(arg0);}
void f182( GfxDebugDrawer *obj) { obj->~GfxDebugDrawer();}
Script *f183(const String & arg0) {return NEW(Script, arg0);}
Script *f184(const String & arg0, const String & arg1) {return NEW(Script, arg0, arg1);}
GfxMaterial *f185(const String & arg0) {return NEW(GfxMaterial, arg0);}
GfxMaterial *f186(const String & arg0, const String & arg1) {return NEW(GfxMaterial, arg0, arg1);}
LookupException *f187(const char * arg0, size_t arg1, const char * arg2) {return NEW(LookupException, arg0, arg1, arg2);}
GfxRenderer *f188() {return NEW(GfxRenderer);}
GfxRenderer *f189(size_t count) {return NEW_ARRAY(GfxRenderer, count);}
Quaternion *f190() {return NEW(Quaternion);}
Quaternion *f191(size_t count) {return NEW_ARRAY(Quaternion, count);}
Quaternion *f192(const Direction3D & arg0, float arg1) {return NEW(Quaternion, arg0, arg1);}
Quaternion *f193(float arg0, float arg1, float arg2, float arg3) {return NEW(Quaternion, arg0, arg1, arg2, arg3);}
Quaternion *f194(const Float3 & arg0) {return NEW(Quaternion, arg0);}
PhysicsShape *f195(const String & arg0) {return NEW(PhysicsShape, arg0);}
PhysicsShape *f196(const String & arg0, const String & arg1) {return NEW(PhysicsShape, arg0, arg1);}
ShaderCompileException *f197(const char * arg0, size_t arg1, const char * arg2, const String & arg3) {return NEW(ShaderCompileException, arg0, arg1, arg2, arg3);}
Exception *f198(const char * arg0, size_t arg1, const char * arg2) {return NEW(Exception, arg0, arg1, arg2);}
GfxForwardMaterialImpl *f199() {return NEW(GfxForwardMaterialImpl);}
GfxForwardMaterialImpl *f200(size_t count) {return NEW_ARRAY(GfxForwardMaterialImpl, count);}
FileException *f201(const char * arg0, size_t arg1, const char * arg2, String arg3, String arg4) {return NEW(FileException, arg0, arg1, arg2, arg3, arg4);}
...
GfxTexture *f203(const String & arg0, const String & arg1) {return NEW(GfxTexture, arg0, arg1);}
GfxTexture *f204(const String & arg0) {return NEW(GfxTexture, arg0);}
PhysicsShapeImpl *f205() {return NEW(PhysicsShapeImpl);}
PhysicsShapeImpl *f206(size_t count) {return NEW_ARRAY(PhysicsShapeImpl, count);}
PhysicsDebugDrawer *f207() {return NEW(PhysicsDebugDrawer);}
PhysicsDebugDrawer *f208(size_t count) {return NEW_ARRAY(PhysicsDebugDrawer, count);}
Application *f209(const char * arg0) {return NEW(Application, arg0);}
GfxModel *f210(const String & arg0) {return NEW(GfxModel, arg0);}
GfxModel *f211(const String & arg0, const String & arg1) {return NEW(GfxModel, arg0, arg1);}
Scene *f212(const String & arg0) {return NEW(Scene, arg0);}
Scene *f213(const String & arg0, const String & arg1) {return NEW(Scene, arg0, arg1);}
File *f214(const char * arg0, const char * arg1) {return NEW(File, arg0, arg1);}
Matrix3x3 *f215() {return NEW(Matrix3x3);}
Matrix3x3 *f216(size_t count) {return NEW_ARRAY(Matrix3x3, count);}
Matrix3x3 *f217(const Matrix4x4 & arg0) {return NEW(Matrix3x3, arg0);}
Matrix3x3 *f218(const Float3 & arg0, const Float3 & arg1, const Float3 & arg2) {return NEW(Matrix3x3, arg0, arg1, arg2);}
GfxDebugDrawer *f219(GfxApi * arg0) {return NEW(GfxDebugDrawer, arg0);}
