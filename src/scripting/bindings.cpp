...
scripting::Value *File_copy(scripting::Context*,scripting::NativeObject*);
void File_destroy(scripting::Context*,scripting::NativeObject*);
scripting::Value *File_get_member(scripting::Context*,scripting::NativeObject*,scripting::Value *);
void File_set_member(scripting::Context*,scripting::NativeObject*,scripting::Value*,scripting::Value*);
static const scripting::NativeObjectFuncs File_funcs={
...
{
if(head->type==scripting::ValueType::NativeObject)
return((scripting::NativeObject*)head)->typeID==((BindingsExt*)ctx->getEngine()->getExtension("bindings").data)->File_typeID;
else
 return false;
}
};

scripting::Value *File_read(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_write(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_seek(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_tell(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_flush(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_isAtEndOfFile(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_getSize(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt8(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt8(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt16LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt16LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt32LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt32LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt64LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt64LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt16BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt16BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt32BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt32BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readUInt64BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readInt64BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readFloat32(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_readChar(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt8(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt8(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt16LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt16LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt32LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt32LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt64LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt64LE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt16BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt16BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt32BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt32BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeUInt64BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeInt64BE(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeFloat32(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_printf(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_vprintf(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *File_writeChar(scripting::Context *ctx, const List<scripting::Value *>& args);
...
scripting::Value *Camera_copy(scripting::Context*,scripting::NativeObject*);
void Camera_destroy(scripting::Context*,scripting::NativeObject*);
scripting::Value *Camera_get_member(scripting::Context*,scripting::NativeObject*,scripting::Value *);
void Camera_set_member(scripting::Context*,scripting::NativeObject*,scripting::Value*,scripting::Value*);
static const scripting::NativeObjectFuncs Camera_funcs={
...
{
static scripting::Value *f(scripting::Context*ctx,const Camera&obj)
{
return scripting::createNativeObject(Camera_funcs,NEW(Camera, obj),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_typeID);
}
};
template <>
struct val_to_c<Camera>
{
static Camera f(scripting::Context*ctx,const scripting::Value*head)
{
if(head->type==scripting::ValueType::NativeObject)
{
scripting::NativeObject*obj=(scripting::NativeObject*)head;
if(obj->typeID==((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_typeID)
return *((Camera*)obj->data);
else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value can not be converted to Camera."));
} else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value can not be converted to Camera."));
}
};
...
{
if(head->type==scripting::ValueType::NativeObject)
return((scripting::NativeObject*)head)->typeID==((BindingsExt*)ctx->getEngine()->getExtension("bindings").data)->Camera_typeID;
else
 return false;
}
};

scripting::Value *Camera_setType(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setPosition(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setDirection(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setUp(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setWidth(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setHeight(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setFieldOfView(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setLeft(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setRight(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setBottom(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setTop(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setNear(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_setFar(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getType(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getPosition(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getDirection(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getUp(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getWidth(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getHeight(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getFieldOfView(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getLeft(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getRight(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getBottom(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getTop(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getNear(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getFar(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getViewMatrix(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Camera_getProjectionMatrix(scripting::Context *ctx, const List<scripting::Value *>& args);
...
scripting::Value *Quaternion_copy(scripting::Context*,scripting::NativeObject*);
void Quaternion_destroy(scripting::Context*,scripting::NativeObject*);
scripting::Value *Quaternion_get_member(scripting::Context*,scripting::NativeObject*,scripting::Value *);
void Quaternion_set_member(scripting::Context*,scripting::NativeObject*,scripting::Value*,scripting::Value*);
static const scripting::NativeObjectFuncs Quaternion_funcs={
...
{
static scripting::Value *f(scripting::Context*ctx,const Quaternion&obj)
{
return scripting::createNativeObject(Quaternion_funcs,NEW(Quaternion, obj),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID);
}
};
template <>
struct val_to_c<Quaternion>
{
static Quaternion f(scripting::Context*ctx,const scripting::Value*head)
{
if(head->type==scripting::ValueType::NativeObject)
{
scripting::NativeObject*obj=(scripting::NativeObject*)head;
if(obj->typeID==((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID)
return *((Quaternion*)obj->data);
else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value can not be converted to Quaternion."));
} else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value can not be converted to Quaternion."));
}
};
...
{
if(head->type==scripting::ValueType::NativeObject)
return((scripting::NativeObject*)head)->typeID==((BindingsExt*)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID;
else
 return false;
}
};

scripting::Value *Quaternion___mul__(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_toMatrix(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion___eq__(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_normalize(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getAngle(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getXAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getYAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getZAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getAxisAndAngle(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setAngle(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setXAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setYAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setZAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setAxis(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setAxisAndAngle(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_setEulerAngles(scripting::Context *ctx, const List<scripting::Value *>& args);
scripting::Value *Quaternion_getEulerAngles(scripting::Context *ctx, const List<scripting::Value *>& args);
...
scripting::Value *File_ptr_copy(scripting::Context*,scripting::NativeObject*);
void File_ptr_destroy(scripting::Context*,scripting::NativeObject*);
scripting::Value *File_ptr_get_member(scripting::Context*,scripting::NativeObject*,scripting::Value *);
void File_ptr_set_member(scripting::Context*,scripting::NativeObject*,scripting::Value*,scripting::Value*);
static const scripting::NativeObjectFuncs File_ptr_funcs={
...
{
static scripting::Value *f(scripting::Context*ctx,File*obj)
{
AllocInfo i=getAllocInfo((void*)obj);
i.cppRef = false;
i.scriptRef = true;
setAllocInfo((void *)obj, i);
return scripting::createNativeObject(File_ptr_funcs,obj,((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->File_ptr_typeID);
}
};
template <>
struct val_to_c<File *>
{
static File *f(scripting::Context*ctx,const scripting::Value*head)
{
if(head->type==scripting::ValueType::NativeObject)
{
scripting::NativeObject*obj=(scripting::NativeObject*)head;
if(obj->typeID==((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->File_ptr_typeID)
return (File*)obj->data;
else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value is not a FileRef."));
} else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value is not a FileRef."));
}
};
...
{
if(head->type==scripting::ValueType::NativeObject)
return((scripting::NativeObject*)head)->typeID==((BindingsExt*)ctx->getEngine()->getExtension("bindings").data)->File_ptr_typeID;
else
 return false;
}
};
...
scripting::Value *Camera_ptr_copy(scripting::Context*,scripting::NativeObject*);
void Camera_ptr_destroy(scripting::Context*,scripting::NativeObject*);
scripting::Value *Camera_ptr_get_member(scripting::Context*,scripting::NativeObject*,scripting::Value *);
void Camera_ptr_set_member(scripting::Context*,scripting::NativeObject*,scripting::Value*,scripting::Value*);
static const scripting::NativeObjectFuncs Camera_ptr_funcs={
...
struct create_val<Camera *>
{
static scripting::Value *f(scripting::Context*ctx,Camera*obj)
{
AllocInfo i=getAllocInfo((void*)obj);
i.cppRef = false;
i.scriptRef = true;
setAllocInfo((void *)obj, i);
return scripting::createNativeObject(Camera_ptr_funcs,obj,((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_ptr_typeID);
}
};
template <>
struct val_to_c<Camera *>
...
{
scripting::NativeObject*obj=(scripting::NativeObject*)head;
if(obj->typeID==((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_ptr_typeID)
return (Camera*)obj->data;
else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value is not a CameraRef."));
} else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value is not a CameraRef."));
}
};
...
{
if(head->type==scripting::ValueType::NativeObject)
return((scripting::NativeObject*)head)->typeID==((BindingsExt*)ctx->getEngine()->getExtension("bindings").data)->Camera_ptr_typeID;
else
 return false;
}
};
...
scripting::Value *Quaternion_ptr_copy(scripting::Context*,scripting::NativeObject*);
void Quaternion_ptr_destroy(scripting::Context*,scripting::NativeObject*);
scripting::Value *Quaternion_ptr_get_member(scripting::Context*,scripting::NativeObject*,scripting::Value *);
void Quaternion_ptr_set_member(scripting::Context*,scripting::NativeObject*,scripting::Value*,scripting::Value*);
static const scripting::NativeObjectFuncs Quaternion_ptr_funcs={
...
struct create_val<Quaternion *>
{
static scripting::Value *f(scripting::Context*ctx,Quaternion*obj)
{
AllocInfo i=getAllocInfo((void*)obj);
i.cppRef = false;
i.scriptRef = true;
setAllocInfo((void *)obj, i);
return scripting::createNativeObject(Quaternion_ptr_funcs,obj,((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_ptr_typeID);
}
};
template <>
struct val_to_c<Quaternion *>
...
{
scripting::NativeObject*obj=(scripting::NativeObject*)head;
if(obj->typeID==((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_ptr_typeID)
return (Quaternion*)obj->data;
else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value is not a QuaternionRef."));
} else
 ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Value is not a QuaternionRef."));
}
};
...
{
if(head->type==scripting::ValueType::NativeObject)
return((scripting::NativeObject*)head)->typeID==((BindingsExt*)ctx->getEngine()->getExtension("bindings").data)->Quaternion_ptr_typeID;
else
 return false;
}
};
...
void File_destroy(scripting::Context*ctx,scripting::NativeObject*self)
{
if(!type_same<File>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::__del__ expects File as first argument."));

DELETE(File,(File *)self->data);
}scripting::Value *File_new(scripting::Context*ctx,const List<scripting::Value *>&args)
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File's constructor expects at least one argument."));
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File's constructor expects File as first argument."));
if(args.getCount()==3)
if(true&&type_same<const char *>::f(ctx,args[1])&&type_same<const char *>::f(ctx,args[2]))
return scripting::createNativeObject(File_funcs,NEW(File,val_to_c<const char *>::f(ctx,args[1]),val_to_c<const char *>::f(ctx,args[2])),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->File_typeID);
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File's constructor."));
return scripting::createNil();
}

scripting::Value *File_get_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key)
{
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue *)key)->value;
...
return scripting::createString("File");
else if(keyStr=="__new__")
return scripting::createNativeFunction(File_new);
else if(keyStr=="__call__")
return scripting::createNativeFunction(File_new);
else
 ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
...
return scripting::createNativeFunction(File_read);
 else if (keyStr == "write")
return scripting::createNativeFunction(File_write);
 else if (keyStr == "seek")
return scripting::createNativeFunction(File_seek);
 else if (keyStr == "tell")
return scripting::createNativeFunction(File_tell);
 else if (keyStr == "flush")
return scripting::createNativeFunction(File_flush);
 else if (keyStr == "isAtEndOfFile")
return scripting::createNativeFunction(File_isAtEndOfFile);
 else if (keyStr == "getSize")
return scripting::createNativeFunction(File_getSize);
 else if (keyStr == "readUInt8")
return scripting::createNativeFunction(File_readUInt8);
 else if (keyStr == "readInt8")
return scripting::createNativeFunction(File_readInt8);
 else if (keyStr == "readUInt16LE")
return scripting::createNativeFunction(File_readUInt16LE);
 else if (keyStr == "readInt16LE")
return scripting::createNativeFunction(File_readInt16LE);
 else if (keyStr == "readUInt32LE")
return scripting::createNativeFunction(File_readUInt32LE);
 else if (keyStr == "readInt32LE")
return scripting::createNativeFunction(File_readInt32LE);
 else if (keyStr == "readUInt64LE")
return scripting::createNativeFunction(File_readUInt64LE);
 else if (keyStr == "readInt64LE")
return scripting::createNativeFunction(File_readInt64LE);
 else if (keyStr == "readUInt16BE")
return scripting::createNativeFunction(File_readUInt16BE);
 else if (keyStr == "readInt16BE")
return scripting::createNativeFunction(File_readInt16BE);
 else if (keyStr == "readUInt32BE")
return scripting::createNativeFunction(File_readUInt32BE);
 else if (keyStr == "readInt32BE")
return scripting::createNativeFunction(File_readInt32BE);
 else if (keyStr == "readUInt64BE")
return scripting::createNativeFunction(File_readUInt64BE);
 else if (keyStr == "readInt64BE")
return scripting::createNativeFunction(File_readInt64BE);
 else if (keyStr == "readFloat32")
return scripting::createNativeFunction(File_readFloat32);
 else if (keyStr == "readChar")
return scripting::createNativeFunction(File_readChar);
 else if (keyStr == "writeUInt8")
return scripting::createNativeFunction(File_writeUInt8);
 else if (keyStr == "writeInt8")
return scripting::createNativeFunction(File_writeInt8);
 else if (keyStr == "writeUInt16LE")
return scripting::createNativeFunction(File_writeUInt16LE);
 else if (keyStr == "writeInt16LE")
return scripting::createNativeFunction(File_writeInt16LE);
 else if (keyStr == "writeUInt32LE")
return scripting::createNativeFunction(File_writeUInt32LE);
 else if (keyStr == "writeInt32LE")
return scripting::createNativeFunction(File_writeInt32LE);
 else if (keyStr == "writeUInt64LE")
return scripting::createNativeFunction(File_writeUInt64LE);
 else if (keyStr == "writeInt64LE")
return scripting::createNativeFunction(File_writeInt64LE);
 else if (keyStr == "writeUInt16BE")
return scripting::createNativeFunction(File_writeUInt16BE);
 else if (keyStr == "writeInt16BE")
return scripting::createNativeFunction(File_writeInt16BE);
 else if (keyStr == "writeUInt32BE")
return scripting::createNativeFunction(File_writeUInt32BE);
 else if (keyStr == "writeInt32BE")
return scripting::createNativeFunction(File_writeInt32BE);
 else if (keyStr == "writeUInt64BE")
return scripting::createNativeFunction(File_writeUInt64BE);
 else if (keyStr == "writeInt64BE")
return scripting::createNativeFunction(File_writeInt64BE);
 else if (keyStr == "writeFloat32")
return scripting::createNativeFunction(File_writeFloat32);
 else if (keyStr == "printf")
return scripting::createNativeFunction(File_printf);
 else if (keyStr == "vprintf")
return scripting::createNativeFunction(File_vprintf);
 else if (keyStr == "writeChar")
return scripting::createNativeFunction(File_writeChar);
 else
 ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
}
}
...
void File_set_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key,scripting::Value*value)
{
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue*)key)->value;
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readFloat32 expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readFloat32 expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==1)
if(1)
{
return create_val<float>::f(ctx,  self->readFloat32());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readFloat32."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::printf expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::printf expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::printf."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt8 expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt8 expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint8_t>::f(ctx,  self->readUInt8());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt8."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::getSize expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::getSize expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<size_t>::f(ctx,  self->getSize());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::getSize."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt32LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt32LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int32_t>::f(ctx,  self->readInt32LE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt32LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::flush expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::flush expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::flush."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeChar expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeChar expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<char>::f(ctx,args[1]))
{
( self->writeChar(val_to_c<char>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeChar."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::seek expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::seek expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::seek."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt8 expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt8 expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int8_t>::f(ctx,  self->readInt8());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt8."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt32BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt32BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int32_t>::f(ctx,  self->readInt32BE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt32BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt32BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt32BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<int32_t>::f(ctx,args[1]))
{
( self->writeInt32BE(val_to_c<int32_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt32BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt64LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt64LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int64_t>::f(ctx,  self->readInt64LE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt64LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt32BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt32BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<uint32_t>::f(ctx,args[1]))
{
( self->writeUInt32BE(val_to_c<uint32_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt32BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt64LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt64LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<uint64_t>::f(ctx,args[1]))
{
( self->writeUInt64LE(val_to_c<uint64_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt64LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::write expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::write expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::write."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeFloat32 expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeFloat32 expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->writeFloat32(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeFloat32."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt64BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt64BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<int64_t>::f(ctx,args[1]))
{
( self->writeInt64BE(val_to_c<int64_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt64BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt32LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt32LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint32_t>::f(ctx,  self->readUInt32LE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt32LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::tell expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::tell expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<long>::f(ctx,  self->tell());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::tell."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt32LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt32LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<uint32_t>::f(ctx,args[1]))
{
( self->writeUInt32LE(val_to_c<uint32_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt32LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::vprintf expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::vprintf expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::vprintf."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt64BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt64BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<uint64_t>::f(ctx,args[1]))
{
( self->writeUInt64BE(val_to_c<uint64_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt64BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::read expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::read expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::read."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt64BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt64BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int64_t>::f(ctx,  self->readInt64BE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt64BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt16LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt16LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<int16_t>::f(ctx,args[1]))
{
( self->writeInt16LE(val_to_c<int16_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt16LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::isAtEndOfFile expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::isAtEndOfFile expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<bool>::f(ctx,  self->isAtEndOfFile());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::isAtEndOfFile."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt64LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt64LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<int64_t>::f(ctx,args[1]))
{
( self->writeInt64LE(val_to_c<int64_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt64LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt32BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt32BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint32_t>::f(ctx,  self->readUInt32BE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt32BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readChar expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readChar expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<char>::f(ctx,  self->readChar());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readChar."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt16BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt16BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint16_t>::f(ctx,  self->readUInt16BE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt16BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt32LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt32LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<int32_t>::f(ctx,args[1]))
{
( self->writeInt32LE(val_to_c<int32_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt32LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt64LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt64LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint64_t>::f(ctx,  self->readUInt64LE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt64LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt16LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt16LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<uint16_t>::f(ctx,args[1]))
{
( self->writeUInt16LE(val_to_c<uint16_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt16LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt8 expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt8 expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<int8_t>::f(ctx,args[1]))
{
( self->writeInt8(val_to_c<int8_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt8."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt16BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt16BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int16_t>::f(ctx,  self->readInt16BE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt16BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt16BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt16BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<uint16_t>::f(ctx,args[1]))
{
( self->writeUInt16BE(val_to_c<uint16_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt16BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeUInt8 expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeUInt8 expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<uint8_t>::f(ctx,args[1]))
{
( self->writeUInt8(val_to_c<uint8_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeUInt8."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readInt16LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readInt16LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<int16_t>::f(ctx,  self->readInt16LE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readInt16LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt16LE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt16LE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint16_t>::f(ctx,  self->readUInt16LE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt16LE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::readUInt64BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::readUInt64BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<uint64_t>::f(ctx,  self->readUInt64BE());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::readUInt64BE."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::writeInt16BE expects at least one argument."));
File*self;
if(!type_same<File>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File::writeInt16BE expects File as first argument."));
else
 self=(File*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<int16_t>::f(ctx,args[1]))
{
( self->writeInt16BE(val_to_c<int16_t>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for File::writeInt16BE."));
return scripting::createNil();
}
...
void Camera_destroy(scripting::Context*ctx,scripting::NativeObject*self)
{
if(!type_same<Camera>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::__del__ expects Camera as first argument."));

DELETE(Camera,(Camera *)self->data);
}scripting::Value *Camera_new(scripting::Context*ctx,const List<scripting::Value *>&args)
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera's constructor expects at least one argument."));
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera's constructor expects Camera as first argument."));
if(args.getCount()==1)
if(true)
return scripting::createNativeObject(Camera_funcs,NEW(Camera),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_typeID);
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera's constructor."));
return scripting::createNil();
}

scripting::Value *Camera_get_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key)
{
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue *)key)->value;
...
return scripting::createString("Camera");
else if(keyStr=="__new__")
return scripting::createNativeFunction(Camera_new);
else if(keyStr=="__call__")
return scripting::createNativeFunction(Camera_new);
else
 ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
...
return scripting::createNativeFunction(Camera_new);
 else if (keyStr == "setType")
return scripting::createNativeFunction(Camera_setType);
 else if (keyStr == "setPosition")
return scripting::createNativeFunction(Camera_setPosition);
 else if (keyStr == "setDirection")
return scripting::createNativeFunction(Camera_setDirection);
 else if (keyStr == "setUp")
return scripting::createNativeFunction(Camera_setUp);
 else if (keyStr == "setWidth")
return scripting::createNativeFunction(Camera_setWidth);
 else if (keyStr == "setHeight")
return scripting::createNativeFunction(Camera_setHeight);
 else if (keyStr == "setFieldOfView")
return scripting::createNativeFunction(Camera_setFieldOfView);
 else if (keyStr == "setLeft")
return scripting::createNativeFunction(Camera_setLeft);
 else if (keyStr == "setRight")
return scripting::createNativeFunction(Camera_setRight);
 else if (keyStr == "setBottom")
return scripting::createNativeFunction(Camera_setBottom);
 else if (keyStr == "setTop")
return scripting::createNativeFunction(Camera_setTop);
 else if (keyStr == "setNear")
return scripting::createNativeFunction(Camera_setNear);
 else if (keyStr == "setFar")
return scripting::createNativeFunction(Camera_setFar);
 else if (keyStr == "getType")
return scripting::createNativeFunction(Camera_getType);
 else if (keyStr == "getPosition")
return scripting::createNativeFunction(Camera_getPosition);
 else if (keyStr == "getDirection")
return scripting::createNativeFunction(Camera_getDirection);
 else if (keyStr == "getUp")
return scripting::createNativeFunction(Camera_getUp);
 else if (keyStr == "getWidth")
return scripting::createNativeFunction(Camera_getWidth);
 else if (keyStr == "getHeight")
return scripting::createNativeFunction(Camera_getHeight);
 else if (keyStr == "getFieldOfView")
return scripting::createNativeFunction(Camera_getFieldOfView);
 else if (keyStr == "getLeft")
return scripting::createNativeFunction(Camera_getLeft);
 else if (keyStr == "getRight")
return scripting::createNativeFunction(Camera_getRight);
 else if (keyStr == "getBottom")
return scripting::createNativeFunction(Camera_getBottom);
 else if (keyStr == "getTop")
return scripting::createNativeFunction(Camera_getTop);
 else if (keyStr == "getNear")
return scripting::createNativeFunction(Camera_getNear);
 else if (keyStr == "getFar")
return scripting::createNativeFunction(Camera_getFar);
 else if (keyStr == "getViewMatrix")
return scripting::createNativeFunction(Camera_getViewMatrix);
 else if (keyStr == "getProjectionMatrix")
return scripting::createNativeFunction(Camera_getProjectionMatrix);
 else
 ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
}
}
...
void Camera_set_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key,scripting::Value*value)
{
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue*)key)->value;
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setBottom expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setBottom expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setBottom(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setBottom."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getRight expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getRight expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getRight());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getRight."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setTop expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setTop expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setTop(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setTop."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getWidth expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getWidth expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getWidth());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getWidth."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getDirection expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getDirection expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Direction3D>::f(ctx,  self->getDirection());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getDirection."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getFieldOfView expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getFieldOfView expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getFieldOfView());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getFieldOfView."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setWidth expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setWidth expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setWidth(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setWidth."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setType expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setType expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setType."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setDirection expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setDirection expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<const Direction3D &>::f(ctx,args[1]))
{
( self->setDirection(val_to_c<const Direction3D &>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setDirection."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getLeft expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getLeft expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getLeft());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getLeft."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getProjectionMatrix expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getProjectionMatrix expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Matrix4x4>::f(ctx,  self->getProjectionMatrix());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getProjectionMatrix."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getHeight expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getHeight expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getHeight());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getHeight."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setFar expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setFar expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setFar(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setFar."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setFieldOfView expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setFieldOfView expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setFieldOfView(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setFieldOfView."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getTop expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getTop expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getTop());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getTop."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getBottom expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getBottom expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getBottom());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getBottom."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getFar expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getFar expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getFar());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getFar."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setUp expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setUp expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<const Direction3D &>::f(ctx,args[1]))
{
( self->setUp(val_to_c<const Direction3D &>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setUp."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getType expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getType expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;

ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getType."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setNear expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setNear expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setNear(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setNear."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setPosition expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setPosition expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<const Position3D &>::f(ctx,args[1]))
{
( self->setPosition(val_to_c<const Position3D &>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setPosition."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setLeft expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setLeft expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setLeft(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setLeft."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getPosition expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getPosition expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Position3D>::f(ctx,  self->getPosition());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getPosition."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setHeight expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setHeight expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setHeight(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setHeight."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getViewMatrix expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getViewMatrix expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Matrix4x4>::f(ctx,  self->getViewMatrix());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getViewMatrix."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getNear expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getNear expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getNear());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getNear."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::setRight expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::setRight expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setRight(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::setRight."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::getUp expects at least one argument."));
Camera*self;
if(!type_same<Camera>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Camera::getUp expects Camera as first argument."));
else
 self=(Camera*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Direction3D>::f(ctx,  self->getUp());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Camera::getUp."));
return scripting::createNil();
}
...
void Quaternion_destroy(scripting::Context*ctx,scripting::NativeObject*self)
{
if(!type_same<Quaternion>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::__del__ expects Quaternion as first argument."));

DELETE(Quaternion,(Quaternion *)self->data);
}scripting::Value *Quaternion_new(scripting::Context*ctx,const List<scripting::Value *>&args)
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion's constructor expects at least one argument."));
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion's constructor expects Quaternion as first argument."));
if(args.getCount()==1)
if(true)
return scripting::createNativeObject(Quaternion_funcs,NEW(Quaternion),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID);
if(args.getCount()==3)
if(true&&type_same<const Direction3D &>::f(ctx,args[1])&&type_same<float>::f(ctx,args[2]))
return scripting::createNativeObject(Quaternion_funcs,NEW(Quaternion,val_to_c<const Direction3D &>::f(ctx,args[1]),val_to_c<float>::f(ctx,args[2])),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID);
if(args.getCount()==5)
if(true&&type_same<float>::f(ctx,args[1])&&type_same<float>::f(ctx,args[2])&&type_same<float>::f(ctx,args[3])&&type_same<float>::f(ctx,args[4]))
return scripting::createNativeObject(Quaternion_funcs,NEW(Quaternion,val_to_c<float>::f(ctx,args[1]),val_to_c<float>::f(ctx,args[2]),val_to_c<float>::f(ctx,args[3]),val_to_c<float>::f(ctx,args[4])),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID);
if(args.getCount()==2)
if(true&&type_same<const Float3 &>::f(ctx,args[1]))
return scripting::createNativeObject(Quaternion_funcs,NEW(Quaternion,val_to_c<const Float3 &>::f(ctx,args[1])),((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID);
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion's constructor."));
return scripting::createNil();
}

scripting::Value *Quaternion_get_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key)
{
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue *)key)->value;
...
return scripting::createString("Quaternion");
else if(keyStr=="__new__")
return scripting::createNativeFunction(Quaternion_new);
else if(keyStr=="__call__")
return scripting::createNativeFunction(Quaternion_new);
else
 ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
...
return scripting::createNativeFunction(Quaternion___mul__);
 else if (keyStr == "toMatrix")
return scripting::createNativeFunction(Quaternion_toMatrix);
 else if (keyStr == "__eq__")
return scripting::createNativeFunction(Quaternion___eq__);
 else if (keyStr == "normalize")
return scripting::createNativeFunction(Quaternion_normalize);
 else if (keyStr == "getAngle")
return scripting::createNativeFunction(Quaternion_getAngle);
 else if (keyStr == "getXAxis")
return scripting::createNativeFunction(Quaternion_getXAxis);
 else if (keyStr == "getYAxis")
return scripting::createNativeFunction(Quaternion_getYAxis);
 else if (keyStr == "getZAxis")
return scripting::createNativeFunction(Quaternion_getZAxis);
 else if (keyStr == "getAxis")
return scripting::createNativeFunction(Quaternion_getAxis);
 else if (keyStr == "getAxisAndAngle")
return scripting::createNativeFunction(Quaternion_getAxisAndAngle);
 else if (keyStr == "setAngle")
return scripting::createNativeFunction(Quaternion_setAngle);
 else if (keyStr == "setXAxis")
return scripting::createNativeFunction(Quaternion_setXAxis);
 else if (keyStr == "setYAxis")
return scripting::createNativeFunction(Quaternion_setYAxis);
 else if (keyStr == "setZAxis")
return scripting::createNativeFunction(Quaternion_setZAxis);
 else if (keyStr == "setAxis")
return scripting::createNativeFunction(Quaternion_setAxis);
 else if (keyStr == "setAxisAndAngle")
return scripting::createNativeFunction(Quaternion_setAxisAndAngle);
 else if (keyStr == "setEulerAngles")
return scripting::createNativeFunction(Quaternion_setEulerAngles);
 else if (keyStr == "getEulerAngles")
return scripting::createNativeFunction(Quaternion_getEulerAngles);
 else if(keyStr=="x")
{
Quaternion*obj=(Quaternion*)self->data;
return create_val<decltype(obj->x)>::f(ctx,obj->x);
} else if(keyStr=="y")
{
Quaternion*obj=(Quaternion*)self->data;
...
void Quaternion_set_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key,scripting::Value*value)
{
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue*)key)->value;
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::normalize expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::normalize expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==1)
if(1)
{
return create_val<Quaternion>::f(ctx,  self->normalize());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::normalize."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setEulerAngles expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setEulerAngles expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<const Float3 &>::f(ctx,args[1]))
{
( self->setEulerAngles(val_to_c<const Float3 &>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setEulerAngles."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getAngle expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getAngle expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getAngle());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getAngle."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Direction3D>::f(ctx,  self->getAxis());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setAngle expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setAngle expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setAngle(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setAngle."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setYAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setYAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setYAxis(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setYAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getEulerAngles expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getEulerAngles expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Float3>::f(ctx,  self->getEulerAngles());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getEulerAngles."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setAxisAndAngle expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setAxisAndAngle expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==3)
if(1&&type_same<const Direction3D &>::f(ctx,args[1])&&type_same<float>::f(ctx,args[2]))
{
( self->setAxisAndAngle(val_to_c<const Direction3D &>::f(ctx,args[1]), val_to_c<float>::f(ctx,args[2])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setAxisAndAngle."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getAxisAndAngle expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getAxisAndAngle expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Float4>::f(ctx,  self->getAxisAndAngle());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getAxisAndAngle."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<const Direction3D &>::f(ctx,args[1]))
{
( self->setAxis(val_to_c<const Direction3D &>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::__mul__ expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::__mul__ expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;

if(args.getCount()==2)
if(1&&type_same<const Quaternion &>::f(ctx,args[1]))
{
return create_val<Quaternion>::f(ctx, *self * val_to_c<const Quaternion &>::f(ctx,args[1]));
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::__mul__."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getYAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getYAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getYAxis());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getYAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getXAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getXAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getXAxis());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getXAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::toMatrix expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::toMatrix expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<Matrix4x4>::f(ctx,  self->toMatrix());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::toMatrix."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setZAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setZAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setZAxis(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setZAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::setXAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::setXAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<float>::f(ctx,args[1]))
{
( self->setXAxis(val_to_c<float>::f(ctx,args[1])));
return scripting::createNil();
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::setXAxis."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::__eq__ expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::__eq__ expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1&&type_same<const Quaternion &>::f(ctx,args[1]))
{
return create_val<bool>::f(ctx, *self == val_to_c<const Quaternion &>::f(ctx,args[1]));
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::__eq__."));
return scripting::createNil();
}
...
{
if(args.getCount()<1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::getZAxis expects at least one argument."));
Quaternion*self;
if(!type_same<Quaternion>::f(ctx, args[0]))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Quaternion::getZAxis expects Quaternion as first argument."));
else
 self=(Quaternion*)((scripting::NativeObject*)args[0])->data;
...
if(1)
{
return create_val<float>::f(ctx,  self->getZAxis());
;
}
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"Unable to find overload for Quaternion::getZAxis."));
return scripting::createNil();
}
...
scripting::Value *File_ptr_new(scripting::Context*ctx,const List<scripting::Value*>&args)
{
List<scripting::Value *> args2 = args.copy();
args2[0]=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->File;
scripting::NativeObject *obj=(scripting::NativeObject*)File_new(ctx, args2);
obj->funcs=File_ptr_funcs;
obj->typeID=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->File_ptr_typeID;
setAllocInfo(obj->data, AllocInfo(true, false));
return (scripting::Value*)obj;
}
scripting::Value *File_ptr_deref(scripting::Context*ctx,const List<scripting::Value*>&args)
{
if(args.getCount()!=1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"FileRef::deref expects one argument."));
scripting::Value*self=args[0];
if(!type_same<File *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"FileRef::deref expects FileRef as first argument."));
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File objects are not copyable."));
}
scripting::Value *File_ptr_set(scripting::Context*ctx,const List<scripting::Value*>&args)
{
if(args.getCount()!=2)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"File::refset expects two arguments."));
scripting::Value*self=args[0];
if(!type_same<File *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"FileRef::refset expects FileRef as first argument."));
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"File objects are not copyable."));
return scripting::createNil();
}

void File_ptr_destroy(scripting::Context*ctx,scripting::NativeObject*self)
{
if(!type_same<File *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"FileRef::__del__ expects FileRef as first argument."));
SCRIPT_DELETE(File, (File *)self->data);
}
scripting::Value *File_ptr_get_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key)
{
if(!type_same<File *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"FileRef's get method expects FileRef as first argument."));
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue *)key)->value;
if(self->data==NULL)
...
return scripting::createString("FilePtr");
else if(keyStr=="__new__")
return scripting::createNativeFunction(File_ptr_new);
else if(keyStr=="__call__")
return scripting::createNativeFunction(File_ptr_new);
else
ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
...
{
if(keyStr=="deref") return scripting::createNativeFunction(File_ptr_deref);
if(keyStr=="refset") return scripting::createNativeFunction(File_ptr_set);
}
}
scripting::NativeObject obj;
obj.head.type=scripting::ValueType::NativeObject;
obj.funcs=File_funcs;
obj.typeID=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->File_typeID;
obj.refCount=1;
obj.data=self->data;
return File_get_member(ctx, &obj, key);
}
void File_ptr_set_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key,scripting::Value*value)
{
if(!type_same<File *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"FileRef's get method expects FileRef as first argument."));
scripting::NativeObject obj;
...
scripting::Value *Camera_ptr_new(scripting::Context*ctx,const List<scripting::Value*>&args)
{
List<scripting::Value *> args2 = args.copy();
args2[0]=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera;
scripting::NativeObject *obj=(scripting::NativeObject*)Camera_new(ctx, args2);
obj->funcs=Camera_ptr_funcs;
obj->typeID=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_ptr_typeID;
setAllocInfo(obj->data, AllocInfo(true, false));
return (scripting::Value*)obj;
}
scripting::Value *Camera_ptr_deref(scripting::Context*ctx,const List<scripting::Value*>&args)
{
if(args.getCount()!=1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"CameraRef::deref expects one argument."));
scripting::Value*self=args[0];
if(!type_same<Camera *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"CameraRef::deref expects CameraRef as first argument."));
return create_val<Camera>::f(ctx, *(Camera *)((scripting::NativeObject *)self)->data);
}
scripting::Value *Camera_ptr_set(scripting::Context*ctx,const List<scripting::Value*>&args)
{
if(args.getCount()!=2)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Camera::refset expects two arguments."));
scripting::Value*self=args[0];
if(!type_same<Camera *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"CameraRef::refset expects CameraRef as first argument."));
*((Camera *)((scripting::NativeObject *)self)->data) = val_to_c<Camera>::f(ctx,args[1]);
return scripting::createNil();
}

void Camera_ptr_destroy(scripting::Context*ctx,scripting::NativeObject*self)
{
if(!type_same<Camera *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"CameraRef::__del__ expects CameraRef as first argument."));
SCRIPT_DELETE(Camera, (Camera *)self->data);
}
scripting::Value *Camera_ptr_get_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key)
{
if(!type_same<Camera *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"CameraRef's get method expects CameraRef as first argument."));
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue *)key)->value;
if(self->data==NULL)
...
return scripting::createString("CameraPtr");
else if(keyStr=="__new__")
return scripting::createNativeFunction(Camera_ptr_new);
else if(keyStr=="__call__")
return scripting::createNativeFunction(Camera_ptr_new);
else
ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
...
{
if(keyStr=="deref") return scripting::createNativeFunction(Camera_ptr_deref);
if(keyStr=="refset") return scripting::createNativeFunction(Camera_ptr_set);
}
}
scripting::NativeObject obj;
obj.head.type=scripting::ValueType::NativeObject;
obj.funcs=Camera_funcs;
obj.typeID=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Camera_typeID;
obj.refCount=1;
obj.data=self->data;
return Camera_get_member(ctx, &obj, key);
}
void Camera_ptr_set_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key,scripting::Value*value)
{
if(!type_same<Camera *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"CameraRef's get method expects CameraRef as first argument."));
scripting::NativeObject obj;
...
scripting::Value *Quaternion_ptr_new(scripting::Context*ctx,const List<scripting::Value*>&args)
{
List<scripting::Value *> args2 = args.copy();
args2[0]=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion;
scripting::NativeObject *obj=(scripting::NativeObject*)Quaternion_new(ctx, args2);
obj->funcs=Quaternion_ptr_funcs;
obj->typeID=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_ptr_typeID;
setAllocInfo(obj->data, AllocInfo(true, false));
return (scripting::Value*)obj;
}
scripting::Value *Quaternion_ptr_deref(scripting::Context*ctx,const List<scripting::Value*>&args)
{
if(args.getCount()!=1)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"QuaternionRef::deref expects one argument."));
scripting::Value*self=args[0];
if(!type_same<Quaternion *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"QuaternionRef::deref expects QuaternionRef as first argument."));
return create_val<Quaternion>::f(ctx, *(Quaternion *)((scripting::NativeObject *)self)->data);
}
scripting::Value *Quaternion_ptr_set(scripting::Context*ctx,const List<scripting::Value*>&args)
{
if(args.getCount()!=2)
ctx->throwException(scripting::createException(scripting::ExcType::ValueError,"Quaternion::refset expects two arguments."));
scripting::Value*self=args[0];
if(!type_same<Quaternion *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"QuaternionRef::refset expects QuaternionRef as first argument."));
*((Quaternion *)((scripting::NativeObject *)self)->data) = val_to_c<Quaternion>::f(ctx,args[1]);
return scripting::createNil();
}

void Quaternion_ptr_destroy(scripting::Context*ctx,scripting::NativeObject*self)
{
if(!type_same<Quaternion *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"QuaternionRef::__del__ expects QuaternionRef as first argument."));
SCRIPT_DELETE(Quaternion, (Quaternion *)self->data);
}
scripting::Value *Quaternion_ptr_get_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key)
{
if(!type_same<Quaternion *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"QuaternionRef's get method expects QuaternionRef as first argument."));
if (key->type==scripting::ValueType::StringType)
{
String keyStr=((scripting::StringValue *)key)->value;
if(self->data==NULL)
...
return scripting::createString("QuaternionPtr");
else if(keyStr=="__new__")
return scripting::createNativeFunction(Quaternion_ptr_new);
else if(keyStr=="__call__")
return scripting::createNativeFunction(Quaternion_ptr_new);
else
ctx->throwException(scripting::createException(scripting::ExcType::KeyError,"Unknown member."));
...
{
if(keyStr=="deref") return scripting::createNativeFunction(Quaternion_ptr_deref);
if(keyStr=="refset") return scripting::createNativeFunction(Quaternion_ptr_set);
}
}
scripting::NativeObject obj;
obj.head.type=scripting::ValueType::NativeObject;
obj.funcs=Quaternion_funcs;
obj.typeID=((BindingsExt *)ctx->getEngine()->getExtension("bindings").data)->Quaternion_typeID;
obj.refCount=1;
obj.data=self->data;
return Quaternion_get_member(ctx, &obj, key);
}
void Quaternion_ptr_set_member(scripting::Context*ctx,scripting::NativeObject*self,scripting::Value*key,scripting::Value*value)
{
if(!type_same<Quaternion *>::f(ctx, (scripting::Value *)self))
ctx->throwException(scripting::createException(scripting::ExcType::TypeError,"QuaternionRef's get method expects QuaternionRef as first argument."));
scripting::NativeObject obj;
