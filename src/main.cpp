...
int main(int argc, const char *argv[])
{
    ...
    #elif 0
    static const char *tokenStrs[] = {"LeftParen",
"RightParen",
"LeftBrace",
"RightBrace",
"LeftBracket",
...
"EndStatement"};
    ...
    try
    {
        List<scripting::Token> tokens = scripting::tokenize("some_module = import(\"some_module.???\")\n"
"\n"
"vec2 = class\n"
...
"}\n"
"\n"
"obj == {member1=6 temp=\"Hello world!\"} == True\n"
"\n"
"counter_r = newref()\n"
"vec2_1_r = newref()\n"
"vec2_1_r := vec2() # Does not copy\n"
"\n"
"vec2_2_r = newref()\n"
"vec2_2_r := vec2(*vec2_1_r) # Does not copy\n"
"\n"
"vec2_1_r.x = vec2_1_r.x + 1;\n"
"\n"
"counter_r := 5 # Does not copy # Returns nil unlike =\n"
"\n"
"delref(vec2_1_r)\n"
"delref(vec2_2_r)\n"
"delref(counter_r)\n");
        ...
        {
            std::cout << tokenStrs[(int)tokens[i].type] << " -> \"" << tokens[i].str.getData() << "\"\n";
        }*/

        tokens = scripting::tokenize("40 + 2");
        ...
        scripting::ASTNode *ast = scripting::createAST(tokens);
